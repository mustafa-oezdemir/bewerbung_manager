...
type Props = Omit<EinfachResumeProps, "accentColor" | "secondaryColor">;
...
export function EinfachPage({
  ...
  const body = (
    <>
      {sections.profile && summary && !isContinuation ? (
        <section className="einfach-section" data-element-id="einfach.summary">
  ...
  return (
    <div className="einfach-page__visual" data-renderer="visual">
      ...
      <footer className="einfach-footer" data-element-id="einfach.footer">
        {portfolio ? (
